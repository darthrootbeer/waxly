...
def find_term_mentions(text: str, term_index: Dict[str, Dict[str, any]]) -> List[Tuple[str, str, str]]:
    ...
    skip_words = {
        ...
        'above', 'below', 'between', 'among', 'under', 'over', 'across', 'around',
        'this', 'that', 'these', 'those', 'a', 'an', 'is', 'are', 'was', 'were',
        'be', 'been', 'being', 'have', 'has', 'had', 'do', 'does', 'did', 'will',
        'would', 'could', 'should', 'may', 'might', 'must', 'can', 'shall',
        'i', 'you', 'he', 'she', 'it', 'we', 'they', 'me', 'him', 'her', 'us', 'them',
        'my', 'your', 'his', 'her', 'its', 'our', 'their', 'mine', 'yours', 'hers', 'ours', 'theirs',
        'plain', 'back', 'front', 'top', 'bottom', 'left', 'right', 'center', 'middle',
...
def create_autolinks(text: str, term_index: Dict[str, Dict[str, any]], current_slug: str) -> str:
            ...
            if dry_run:
                ...
                if data:
                    ...
                    if external_mentions:
                        print(f"Would add {len(external_mentions)} links to {term_file.name}:")
